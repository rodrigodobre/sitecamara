        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                    <div class="card-header">
                        <b>Destaques</b>
                        <a class="float-right" href="<?php echo e(url('admin/noticias/novo')); ?>">
                            ...
                            <?php $__currentLoopData = $noticias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noticia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <ul class="d-block row align-items-center" style="border-bottom: 1px solid #ededed;padding-bottom: 12px;">
                                    ...
                                    <li class="d-block d-sm-inline-block d-md-inline-block d-lg-inline-block col-12 col-sm-12 col-md-2 col-lg-2">
                                        ...
                                        <span class="d-block d-sm-block d-md-none d-lg-block" style="padding-top: 10px;padding-bottom: 10px;text-align: justify;"><?php echo e($noticia->titulo); ?></span>
                                    </li>
                                    ...
                                    <li class="d-block d-sm-inline-block d-md-inline-block d-lg-inline-block col-12 col-sm-12 col-md-4 col-lg-4">
                                        <?php if($noticia->publicado == true): ?>
                                            <?php echo e(Form::open(['method' =>'PATCH','url' => 'admin/noticias/publicar/'.$noticia->id, 'style' => 'display:inline'])); ?>
                                        ...
                                        <?php endif; ?>
                                        <a href="noticias/<?php echo e($noticia->id); ?>/editar" class="btn btn-light" style="background-color: #4ea5ff;color:white;">
                                        ...
                                        <?php echo e(Form::open(['method' =>'DELETE','url' => 'admin/noticias/'.$noticia->id, 'style' => 'display:inline'])); ?>
