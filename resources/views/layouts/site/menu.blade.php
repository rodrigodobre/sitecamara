<div class="menu_fundo">
    ...
    <div class="pesquisar" style="height: 50px;">
        {{ Form::open(['url' => 'resultado','method' => 'PATCH','enctype' => 'multipart/form-data', 'id' => 'pesquisa']) }}
            @csrf
            {{ Form::input('text','pesquisa',null,['placeholder' => 'Pesquisar', 'style' => 'margin-top: 2px;']) }}
            <input type="submit" style="display:none" />
            <button id="botao" style="border:none;background: none;"><img src="{{ asset('public/img/pesquisa.png') }}" style="cursor:pointer;" /></button>
        {{ Form::close() }}
    </div>
</div>
