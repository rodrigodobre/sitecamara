...
<div class="centro" style="text-align:justify-all;">
    ...
    <p>A Câmara Municipal de Ponta Porã está realizando Consulta Pública para complementação na revisão do <b>Código Urbanístico</b> (Lei Complementar n° 71, de 17 de Dezembro de 2010) para se adequar ao planejamento proposto no Plano Diretor do Município (Lei Complementar nº 197, de 15 de Abril de 2020).</p>
    <!-- stoled -->
    </div>
    <div class="container">
        <div class="row align-items-center">
            <div class="col">
                <p style="text-align: center;font-size: x-large;font-weight: bold;margin-top: 15px;margin-bottom: 25px;">Dê a sua sugestão até o dia 28 de junho de 2021.</p>
    ...
    <div class="container">
        {{ Form::open(['url' => 'consulta/salvar', 'enctype' => 'multipart/form-data']) }}
        {{ Form::label('bairro','Qual bairro você mora?') }}
            {{ Form::input('text','bairro',null, ['class' => 'form-control', 'autofocus', 'placeholder' => '', 'maxlenght' => '150', 'spellcheck' => 'true', 'required' => 'required']) }}<br />
            {{ Form::label('sugestao','Escreva aqui a sua sugestão') }}<br />
            {{ Form::textarea('sugestao', null, ['class' => 'form-control', 'autofocus', 'placeholder' => '', 'maxlenght' => '3000', 'spellcheck' => 'true', 'required' => 'required']) }}<br />
            {{ Form::submit('Enviar Sugestão',['class' => 'btn btn-primary']) }}
        {{ Form::close() }}
    </div>
</div>
@endsection
